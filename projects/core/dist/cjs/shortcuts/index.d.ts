...
export declare const Θc: (componentInstance: any, fnComponent: import("../types/fn-component.type").FnComponentType, props?: Record<string, import("..").StateInterface>) => HTMLElement;
